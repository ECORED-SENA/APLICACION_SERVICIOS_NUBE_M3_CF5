  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-principal
      .titulo-principal__numero
        span 2
      h1 Pruebas de acceso: sentencias DCL
    figure
      img(src="@/assets/template/tema-2-1.png" alt="Texto que describa la imagen")
    p.mt-5.mb-3 Es fundamental, en cualquier sistema, garantizar la seguridad de la información, por eso, es de interés conocer las sentencias que permiten asignar y revocar permisos de acceso sobre los componentes de una base de datos. Ahora, se revisarán las sentencias DCL (Data Control Language).

    #t_2_1.titulo-segundo.mt-5
      .h2.mt-5 2.1  Crear un usuario en MySQL
    p.mt-4 La sentencia para crear un usuario es: 
    .row.mt-5
      .col-12.col-md-12.bg-gris.rounded.text-center.letter-spacing-2
    ...
    AcordionA.mb-5(tipo="b" clase-tarjeta="tarjeta bg-gris-claro").mt-5 
      .row(titulo="Nivel global: ")
        .col-12
          ...
          .row.mt-4
            .col-12.col-md-12.bg-gris.rounded.letter-spacing-2
              .h5.px-5.py-4.mb-0 REVOKE ALL PRIVILEGES ON *.* TO 'newuser'@'localhost';
      ...
      div(titulo="Nivel de base de datos: ")
        ...
        p.mt-4 Ejemplo: crear una base de datos llamada “acl”, crear un usuario llamado acluser que pueda acceder desde el mismo computador con contraseña “98765*1234” y asignarle permisos solo a todos los objetos de la base de datos acl y, posteriormente, revoque los permisos dados.
        .h4.mt-4 Solución:       
        .row.mt-4
          .col-12.col-md-12.bg-gris.rounded.letter-spacing-2
          ...
          .col-12.col-md-12.bg-gris.rounded.letter-spacing-2
            ...
            .row.mt-2
              .col-10.offset-1.px-4
                ul.lista-ul
                  li.mb-1 
                    i.fas.fa-arrow-right(style="color: #12263F;")
      ...
      .row.m-0.align-items-center.justify-content-between
        .col-lg-8
          .bloque-texto-a__texto.p-4
            ...
            p.mt-3 Los niveles pueden conceder otros tipos de acceso, según el tipo de operación a ejecutar sobre el objeto; hasta ahora se ha visto el acceso total o acceso ALL. Otros privilegios que se pueden conceder son:
    ...
    #t_2_3.titulo-segundo.mt-5 
      .h2 2.3  Pruebas de acceso
    figure
      img(src="@/assets/template/tema-2-4.png" alt="Texto que describa la imagen")
    p.mt-4.mb-5 Para la prueba de acceso se revisará un ejemplo de creación de una base de datos llamada #[strong test_acl] con las tablas listadas a continuación; luego, un usuario llamado #[strong readonly] que solo puede hacer selectos sobre todas las tablas y crear otro usuario llamado #[strong insertonly] que únicamente puede insertar datos y, finalmente, uno que se llame #[strong updateonly].
    
    TabsB.color-acento-contenido.mb-5.mt-5
      .py-4.py-md-5(titulo="Crear bases de datos" :icono="require('@/assets/template/tema-2-12.svg')")
        .row.mt-4
          .col-8.col-md-8.bg-gris.rounded.letter-spacing-2
            .row
              .col-lg-12
                .h5.px-5.pt-4.mb-0 mysql> CREATE DATABASE test db;
                .h5.px-5.mt-2.mb-5 Query OK, 1 rows affected (0.01 sec)
                .h5.px-5.mt-2.mb-0 mysql> USE test db;
                .h5.px-5.mt-2.mb-0 Database changed
                .h5.px-5.mt-2.mb-0 mysql> CREATE TABLE persona (
                  .h5.px-5.mt-2.mb-0 -> id_persona INT KEY,
                  .h5.px-5.mt-2.mb-0 -> nombres VARCHAR(100),
                  .h5.px-5.mt-2.mb-0 -> apellidos VARCHAR(100),
                  .h5.px-5.mt-2.mb-0 -> correo VARCHAR(250),
                  .h5.px-5.mt-2.mb-0 -> fecha_nacimiento DATE);
                .h5.px-5.mt-2.mb-0 Query OK, 0 rows affected (0.04 sec) 
                .h5.px-5.mt-5.mb-0 mysql> CREATE TABLE telefono (
                  .h5.px-5.mt-2.mb-0  -> persona_id INT,
                  .h5.px-5.mt-2.mb-0  -> numero VARCHAR(20) PRIMARY KEY);
                .h5.px-5.mt-2.mb-0 Query OK, 0 rows affected (0.02 sec)
                .h5.px-5.mt-5.mb-0 mysql>
        ...
        .row.bg-blanco.py-4.px-2
          .tabla-a.color-acento-botones.mb-5 
            table
              thead
                tr
                  th(style="border-right:1px solid #e0e0e0;") Tabla
                  th(colspan='4' style="border-right:1px solid #e0e0e0;") Persona
                  th(colspan='4' style="border-right:1px solid #e0e0e0;") Teléfonos
              tbody
                tr
                  th USUARIOS
                  th INSERT
